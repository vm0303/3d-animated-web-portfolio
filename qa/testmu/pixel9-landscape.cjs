...
const QA_LABEL = "Pixel-9-Chrome-Landscape";
const BASE_URL =
    ...
    () => {
        ...
        return {
            ...
            latestJson:
                path.join(
                    OUTPUT_DIR,
                    "Pixel-9-Chrome-Landscape__latest.json"
                ),

            latestScreenshot:
                path.join(
                    OUTPUT_DIR,
                    "Pixel-9-Chrome-Landscape__latest.png"
                ),

            diagnosticScreenshot:
                path.join(
                    OUTPUT_DIR,
                    "Pixel-9-Chrome-Landscape__DIAGNOSTIC.png"
                ),

            errorScreenshot:
                path.join(
                    OUTPUT_DIR,
                    "Pixel-9-Chrome-Landscape__ERROR.png"
                ),
        };
    };
...
const forceLandscape =
    async (
        ...
        console.log(
            "Rotating physical Pixel 9 to landscape..."
        );


        /*
          Disable Android auto-rotation,
          then explicitly rotate the Pixel
          90 degrees into landscape.
        */
...
const restoreOrientation =
    async (
        ...
        try {
            /*
              Return to natural portrait first.
            */
            ...
            /*
              Restore normal Android auto-rotation.
            */
...
const analyzeReport =
    (
        ...
        if (
            ...
            reasons.push(
                `Expected landscape but received ${report.viewport.layoutMode}.`
            );
        }
        ...
        /*
          ...
          - horizontal overflow
          - viewport clipping
          - unexpected hidden elements
          - unexpected visible elements
          - image crop-policy failures
          - portrait bubble-placement failures
        */
        ...
        if (overall) {
            ...
            /*
              ...
              This should only execute if
              an older heroQa.js somehow loaded.
            */
...
const printReportSummary =
    (
        ...
        console.log(
            "PIXEL 9 — ANDROID.CONNECT — LANDSCAPE"
        );
        ...
        /*
          Print scroll SVG explicitly because
          it is one of the Pixel 9 landscape
          issues we are validating.
        */
        ...
        if (
            ...
            if (
                ...
                console.log(
                    `Scroll SVG hidden reason: ${scrollSvg
                        .visibility
                        ?.reasons
                        ?.join(", ") ||
                    "unknown"
        ...
        if (
            ...
            console.log(
                `Hero rect: ${hero.rect.width} x ${hero.rect.height}`
            );


            console.log(
                `Hero bottom clipping: ${hero
                    .viewportClipping
                    ?.bottom ??
                0
                }px`
        ...
        if (
            ...
            console.log(
                `Contact link rendered: ${contactLink
                    .visibility
                    ?.rendered
                    ? "YES"
                    : "NO"
            ...
            console.log(
                `Contact link bottom clipping: ${contactLink
                    .viewportClipping
                    ?.bottom ??
                0
                }px`
        ...
        if (
            ...
            console.log(
                `Contact button rendered: ${contactButton
                    .visibility
                    ?.rendered
                    ? "YES"
                    : "NO"
            ...
            console.log(
                `Contact button bottom clipping: ${contactButton
                    .viewportClipping
                    ?.bottom ??
                0
                }px`
...
(async () => {
    ...
    try {
        ...
        console.log(
            `Connected to device: ${device.model()}`
        );
        ...
        /*
          Restart Chrome after rotating so the
          browser initializes in the correct
        ...
        */
        ...
        console.log(
            "Waiting for landscape viewport..."
        );
        ...
        try {
            ...
            console.log(
                "Landscape not detected yet. Rotating again..."
            );
        ...
        /*
          Let fonts, images, React, Three.js
          and the QA stabilizer settle.
        */
        ...
        */
        ...
        if (
            ...
            throw new Error(
                `Device did not enter landscape mode. ` +
        ...
        await setTestMuStatus(
            ...
            analysis.passed
                ? "Portfolio Hero Pixel 9 landscape QA passed."
        ...
        /*
          Make the npm command return non-zero
          whenever Hero QA V4 fails.
        */
